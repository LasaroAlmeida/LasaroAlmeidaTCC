...
-- Dimensão Tempo Mes
CREATE TABLE D_TP_MES(
	ID_TP_MES SERIAL PRIMARY KEY, -- Id Tempo Mes
	TP_MES VARCHAR(10) NOT NULL   -- Tempo Mes
);
...
CREATE TABLE D_CTZC(
	...
	USAR_TMPR_IDCA_TCDO_FP VARCHAR(15),	           -- Usa temperatura indica tecido ferro de passar
...
CREATE TABLE F_CSMO_EE_MSAL(
	...
	FOREIGN KEY(ID_TP_MES) REFERENCES D_TP_MES(ID_TP_MES) ON DELETE CASCADE
);
...
CREATE TABLE F_ETDC(
	...
	TIPO_ETDC VARCHAR(50),				     	-- Tipo Eletrodomestico
	...
	TP_POSSE_ETDC INT,                       	-- Tempo posse do eletrodoméstico
	...
	NU_LVGM_MDL_DIA_USO INT,                	-- Numero Lavagens maquina de lavar dia de uso
